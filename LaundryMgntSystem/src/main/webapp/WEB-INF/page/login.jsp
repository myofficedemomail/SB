            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="#" id="login" class="nav-item nav-link active">Login</a>
                      ...
                      <div class="col-md-4 d-flex align-items-center justify-content-center">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                                <div class="d-inline-flex align-items-center justify-content-center bg-white border border-light shadow rounded-circle mb-4" style="width: 100px; height: 100px; border-width: 15px !important;">
                                    <i class="fa fa-2x fa-solid fa-user text-secondary"></i>
                                </div>
                                <h5 class="font-weight-medium m-0 mt-2">Login</h5>
                            </div>
                      </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="subject" placeholder="Email Id" required="required" data-validation-required-message="Please enter Email Id" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control" id="subject" placeholder="Password" required="required" data-validation-required-message="Please enter Password" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="row d-flex align-items-center justify-content-center">
                                <button class="btn btn-primary py-3 px-5" id="sendMessageButton">Login</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#registerBtn").click(function() {
			document.login.action = "register";
		...
		$("#forgetPassword").click(function() {
			document.login.action = "/forgetPassword";
			document.login.method = "POST";
			document.login.submit();
		});
	});
				...
				<div class="card paint-card">
					...
					<div class="card-body">
						...
						<form class="row g-3" name="login">
							<div class="mb-3">
								<label for="inputEmail4" class="form-label">User</label> <select name="user" class="form-control">
									<option value="0">Select</option>
									<option value="c">Citizen</option>
									<option value="s">Shop</option>
								</select>
							...
							<button id="loginBtn" class="btn bg-primary text-white col-ms-2">Login</button>
						</form>

						<br>
						<p class="text-center  fs-6 fw-bold">
							<a href="#" class="text-decoration-none text-priamry"
								id="registerBtn">Register</a>
						</p>

						<p class="text-center fs-6 fw-bold">
							<a id="forgetPassword" href="#"
								class="text-decoration-none text-priamry">Forgot Password?</a>
						</p>
					</div>
				</div>
			</div>
